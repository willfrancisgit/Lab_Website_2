...
*/
var viewStudentStats = function(id, toggle){
...
*/
var loadPlayersPage	= function(){

	var drop_name = ""
	for(i = 0; i < players.length; i++){
		drop_name += "<a class=\"dropdown-item\" href=\"#\" onclick=\"switchPlayers(" + i + ")\">" + players[i].name + "</a>\n"
   	}
   	document.getElementById("player_selector").innerHTML = drop_name
}
var switchPlayers = function(playerNum){
